...
final class SmartArrayHtml extends SmartArray
{
     ...
     * Use SmartArray::newHtml() to create instances.
     *
     ...
     *
     * @return SmartArrayHtml A new SmartArray indexed by the specified column.
     * @example
     ...
     * @return SmartArrayHtml A new SmartArray containing the extracted values.
     * @example
     * $users = new SmartArray([
     ...
     *
     * @return SmartString The resulting string after joining all elements (as SmartString for HTML safety).
